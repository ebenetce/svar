classdef minnesotanbvarm < normalbvarm & matlab.mixin.CustomDisplay
    ...
    methods
        ...
        function obj = minnesotanbvarm(numseries, numlags, nvp, nvp2)
            ...
            obj  = obj@normalbvarm(numseries, numlags, args{:});
    ...
    methods
        ...
        function [Posterior, Summary] = estimate(obj, Y, opts)
            %ESTIMATE Analytic normal posterior, dummy observations included.
            arguments
                obj
