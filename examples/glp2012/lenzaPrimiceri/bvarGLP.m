...
%% Edu: 
% What they are doing with ols1 is a varm(1,1) wiht constant. To match the
% results exactly ols1 should do a few things differently
% r.bhatols=x\y;
% r.sig2hatols=(r.resols'*r.resols)/nobs;
% r.sigbhatols= (x'*x)/r.sig2hatols;
% for i=1:n    
...
% logMLVAR_formin(x0, y,x,lags,T,n,b,MIN,MAX,SS,Vc,pos,mn,sur,noc,y0,hyperpriors,priorcoef)
